...
#endif
{
	...
	API_V_EXEC_ALLOWED_CHILDREN = 'xeac',
	API_V_EXEC_ALLOWED_PARENTS = 'xeap',
	API_V_EXEC_BLOCKED_CHILDREN = 'xebc',
	API_V_EXEC_BLOCKED_PARENTS = 'xebp',
